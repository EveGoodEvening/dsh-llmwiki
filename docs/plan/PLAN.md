...
- **Status:** C19A active next and not started; C19B explicitly blocked by the stated external prerequisites.
...
- **Status:** complete. Independent static documentation review verdict: CLEAN. Commit `ff4b213` has actual subject `docs: use current packed artifact name` and exactly four paths: `README.md`, `docs/plan/CHECKLIST.md`, `docs/plan/PLAN.md`, and `examples/README.md`. `DEF-STALE-TARBALL`, C18, its review, commit, and ledger are complete. C19A is active next and not started; C19B remains blocked.
...
6. **C19A — Implement the opt-in real-agent smoke** (`GAP-MODEL-E2E` implementation), active next and not started. Commit after keyless preflight/offline-independence verification.
...
C18 is complete. Independent static documentation review verdict: CLEAN. Commit `ff4b213` has actual subject `docs: use current packed artifact name` and exactly four paths: `README.md`, `docs/plan/CHECKLIST.md`, `docs/plan/PLAN.md`, and `examples/README.md`. `DEF-STALE-TARBALL`, C18, its review, commit, and ledger are complete. C19A is active next and not started; C19B remains blocked.
